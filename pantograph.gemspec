...
Gem::Specification.new do |spec|
  ...
  spec.summary       = Pantograph::DESCRIPTION
  ...
  spec.files = Dir.glob('*/lib/**/*', File::FNM_DOTMATCH) + Dir['bin/*'] + Dir['*/README.md'] + %w(README.md LICENSE .yardopts) - Dir['pantograph/lib/pantograph/actions/device_grid/assets/*'] - Dir['pantograph/lib/pantograph/actions/docs/assets/*']
  spec.bindir = 'bin'
  ...
  spec.add_development_dependency('xcov', '~> 1.4.1') # Used for xcov's parameters generation: https://github.com/pantograph/pantograph/pull/12416
