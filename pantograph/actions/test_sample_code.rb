  ...
  module Actions
    class TestSampleCodeAction < Action
      ...
      def self.method_missing(method_sym, *arguments, &_block)
        ...
        if available_options.kind_of?(Array) && available_options.first && available_options.first.kind_of?(PantographCore::ConfigItem)
          ...
          parameters.each do |current_argument, value|
            ...
            if config_item.data_type == Pantograph::Boolean
      ...
      # they don't use the pantograph configuration system
      def self.blacklist
        [
          :import,
          :xcode_select,
      ...
      def self.available_options
        [
          ...
          PantographCore::ConfigItem.new(key: :content)
        ]
      end
