  ...
  module Helper
    module PluginScoresHelper
      ...
      class PantographPluginScore
        ...
        def ratings
          [
            PantographPluginRating.new(key: :contributors,
        ...
        def append_git_data
          Dir.mktmpdir("pantograph-plugin") do |tmp|
            ...
            Dir.chdir(clone_folder) do
              ...
              actions = Dir["**/actions/*.rb"].map do |action_file|
                PantographActionFileParser.new.parse_file(action_file)
              end
        ...
        def append_github_data
          # e.g. https://api.github.com/repos/urbanquakers/pantograph
      ...
      class PantographActionFileParser
        attr_accessor :state
          ...
          lines.each do |line|
            ...
            when :in_class
              ...
              if is_end?(line)
                ...
                actions << PantographPluginAction.new(name: name.pantograph_underscore, category: category, description: description, details: details) unless name.nil?
