describe Pantograph::Helper::GradleHelper do
  describe 'parameter handling' do
    it 'stores a shell-escaped version of the gradle_path when constructed' do
      gradle_path = '/fake gradle/path'
      helper = Pantograph::Helper::GradleHelper.new(gradle_path: gradle_path)
    ...
    it 'updates a shell-escaped version of the gradle_path when modified' do
      gradle_path = '/fake gradle/path'
      helper = Pantograph::Helper::GradleHelper.new(gradle_path: '/different/when/constructed')
