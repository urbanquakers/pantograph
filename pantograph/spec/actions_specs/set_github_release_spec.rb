    ...
    describe "set_github_release" do
      it "sends and receives the right content from GitHub" do
        stub_request(:post, "https://api.github.com/repos/czechboy0/czechboy0.github.io/releases").
          ...
          headers: { 'Authorization' => 'Basic MTIzNDVhYmNkZQ==', 'Host' => 'api.github.com:443', 'User-Agent' => 'pantograph-github_api' }).
          to_return(status: 201, body: File.read("./pantograph/spec/fixtures/requests/github_create_release_response.json"), headers: {})
        ...
        expect(result).to eq(JSON.parse(File.read("./pantograph/spec/fixtures/requests/github_create_release_response.json")))
      end
      ...
      it "can use a generated changelog as the description" do
        ...
        result = Pantograph::PantFile.new.parse("lane :test do
          Actions.lane_context[SharedValues::PANT_CHANGELOG] = 'autogenerated changelog'
          set_github_release(
            repository_name: 'czechboy0/czechboy0.github.io',
            api_token: '12345abcde',
            tag_name: 'tag33',
