  ...
  describe Pantograph::PantFile do
    describe "Slack Action" do
      ...
      it "trims long messages to show the bottom of the messages" do
        long_text = "a" * 10_000
        expect(Pantograph::Actions::SlackAction.trim_message(long_text).length).to eq(7000)
      end
      ...
      it "works so perfect, like Slack does" do
        ...
        Pantograph::Actions.lane_context[Pantograph::Actions::SharedValues::LANE_NAME] = lane_name

        require 'pantograph/actions/slack'
        arguments = Pantograph::ConfigurationHelper.parse(Pantograph::Actions::SlackAction, {
      ...
      # https://github.com/pantograph/pantograph/issues/14234
      ...
      # https://github.com/pantograph/pantograph/issues/14141
