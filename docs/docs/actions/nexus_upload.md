...
To modify it, go to its source at https://github.com/urbanquakers/pantograph/blob/master/pantograph/lib/pantograph/actions/nexus_upload.rb
-->
...
```shell
pantograph action nexus_upload
```
...
```shell
pantograph run nexus_upload
```

To pass parameters, make use of the `:` symbol, for example

```shell
pantograph run nexus_upload parameter1:"value1" parameter2:"value2"
```
...
This action, just like the rest of _pantograph_, is fully open source, <a href="https://github.com/urbanquakers/pantograph/blob/master/pantograph/lib/pantograph/actions/nexus_upload.rb" target="_blank">view the source code on GitHub</a>
