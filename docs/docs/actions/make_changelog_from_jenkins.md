...
To modify it, go to its source at https://github.com/urbanquakers/pantograph/blob/master/pantograph/lib/pantograph/actions/make_changelog_from_jenkins.rb
-->
...
----|-------------|--------
  `fallback_changelog` | Fallback changelog if there is not one on Jenkins, or it could not be read | `''`
...
------------|-------------
  `SharedValues::PANT_CHANGELOG` | The changelog generated by Jenkins
...
```shell
pantograph action make_changelog_from_jenkins
```
...
```shell
pantograph run make_changelog_from_jenkins
```

To pass parameters, make use of the `:` symbol, for example

```shell
pantograph run make_changelog_from_jenkins parameter1:"value1" parameter2:"value2"
```
...
This action, just like the rest of _pantograph_, is fully open source, <a href="https://github.com/urbanquakers/pantograph/blob/master/pantograph/lib/pantograph/actions/make_changelog_from_jenkins.rb" target="_blank">view the source code on GitHub</a>
