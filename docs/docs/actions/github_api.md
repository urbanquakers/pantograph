...
To modify it, go to its source at https://github.com/urbanquakers/pantograph/blob/master/pantograph/lib/pantograph/actions/github_api.rb
-->
...
----|-------------|--------
  ...
  `url` | The complete full url - used instead of path. e.g. 'https://uploads.github.com/repos/pantograph...' | 
...
This action, just like the rest of _pantograph_, is fully open source, <a href="https://github.com/urbanquakers/pantograph/blob/master/pantograph/lib/pantograph/actions/github_api.rb" target="_blank">view the source code on GitHub</a>
