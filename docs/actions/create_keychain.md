...
To modify it, go to its source at https://github.com/johnknapprs/pantograph/blob/master/pantograph/lib/pantograph/actions/create_keychain.rb
-->
...
```no-highlight
pantograph action create_keychain
```
...
```no-highlight
pantograph run create_keychain
```

To pass parameters, make use of the `:` symbol, for example

```no-highlight
pantograph run create_keychain parameter1:"value1" parameter2:"value2"
```
...
This action, just like the rest of _pantograph_, is fully open source, <a href="https://github.com/johnknapprs/pantograph/blob/master/pantograph/lib/pantograph/actions/create_keychain.rb" target="_blank">view the source code on GitHub</a>
