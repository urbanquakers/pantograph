...
To modify it, go to its source at https://github.com/johnknapprs/pantograph/blob/master/pantograph/lib/pantograph/actions/unlock_keychain.rb
-->
...
```no-highlight
pantograph action unlock_keychain
```
...
```no-highlight
pantograph run unlock_keychain
```

To pass parameters, make use of the `:` symbol, for example

```no-highlight
pantograph run unlock_keychain parameter1:"value1" parameter2:"value2"
```
...
This action, just like the rest of _pantograph_, is fully open source, <a href="https://github.com/johnknapprs/pantograph/blob/master/pantograph/lib/pantograph/actions/unlock_keychain.rb" target="_blank">view the source code on GitHub</a>
