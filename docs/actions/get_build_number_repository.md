...
To modify it, go to its source at https://github.com/johnknapprs/pantograph/blob/master/pantograph/lib/pantograph/actions/get_build_number_repository.rb
-->
...
```no-highlight
pantograph action get_build_number_repository
```
...
```no-highlight
pantograph run get_build_number_repository
```

To pass parameters, make use of the `:` symbol, for example

```no-highlight
pantograph run get_build_number_repository parameter1:"value1" parameter2:"value2"
```
...
This action, just like the rest of _pantograph_, is fully open source, <a href="https://github.com/johnknapprs/pantograph/blob/master/pantograph/lib/pantograph/actions/get_build_number_repository.rb" target="_blank">view the source code on GitHub</a>
