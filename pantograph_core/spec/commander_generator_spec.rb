describe PantographCore do
  describe PantographCore::CommanderGenerator do
    describe 'while options parsing' do
      ...
      describe 'pass-through arguments' do
        it 'captures those that are not command names or flags' do
          ...
          program = TestCommanderProgram.run([
                                               PantographCore::ConfigItem.new(key: :boolean_1,
                                                                   short_option: '-b',
      ...
      describe ':shell_string flags' do
        let(:config_items) do
          [
            PantographCore::ConfigItem.new(key: :shell_string_1,
                                short_option: '-s',
      ...
      describe 'Integer flags' do
        let(:config_items) do
          [
            PantographCore::ConfigItem.new(key: :integer_1,
                                short_option: '-i',
      ...
      describe 'Float flags' do
        let(:config_items) do
          [
            PantographCore::ConfigItem.new(key: :float_1,
                                short_option: '-f',
                                 description: 'Float 1',
                                   is_string: false,
                                        type: Float)
